...
public class MainActivity extends AppCompatActivity implements PointsChangeNotify,
    ...
    public void adgateMedia_offerwall(){

        AdGateMedia.getInstance().showOfferWall(this, new AdGateMedia.OnOfferWallClosed() {
            @Override
    ...
    private void initVideoAd() {
        ...
        VideoAdManager.getInstance(this).requestVideoAd(new VideoAdRequestListener() {
            ...
            public void onRequestSucceed() {
                if(Config.debug_mode){Log.e("adxmi", "video request succeed");}
            }

            @Override
            public void onRequestFail(int errorCode) {
                if(Config.debug_mode){Log.e("adxmi", "video request fail");}
            }
        });
    ...
    public void onRewardedVideoAdOpened() {
        if(Config.debug_mode){Log.d(TAG, "onRewardedVideoAdOpened");}
    }

    @Override
    public void onRewardedVideoAdClosed() {
        if(Config.debug_mode){Log.d(TAG, "onRewardedVideoAdClosed");}
    ...
    public void onRewardedVideoAvailabilityChanged(boolean b) {
        ...
        if(Config.debug_mode){Log.d(TAG, "onRewardedVideoAvailabilityChanged" + " " + b);}
    ...
    public void onRewardedVideoAdStarted() {
        ...
        if(Config.debug_mode){Log.d(TAG, "onRewardedVideoAdStarted");}
    }

    @Override
    public void onRewardedVideoAdEnded() {
        // called when the video has ended
        if(Config.debug_mode){Log.d(TAG, "onRewardedVideoAdEnded");}
    }

    @Override
    public void onRewardedVideoAdRewarded(Placement placement) {
        if(Config.debug_mode){Log.d(TAG, "onRewardedVideoAdRewarded" + " " + placement);}
    ...
    public void onRewardedVideoAdShowFailed(IronSourceError ironSourceError) {
        if(Config.debug_mode){Log.d(TAG, "onRewardedVideoAdShowFailed" + " " + ironSourceError);}
    }
    ...
    public void onOfferwallOpened() {
        ...
        if(Config.debug_mode){Log.d(TAG, "onOfferwallOpened");}
    }

    @Override
    public void onOfferwallShowFailed(IronSourceError ironSourceError) {
        if(Config.debug_mode){ Log.d(TAG, "onOfferwallShowFailed" + " " + ironSourceError);}
    }

    @Override
    public boolean onOfferwallAdCredited(int credits, int totalCredits, boolean totalCreditsFlag) {
        if(Config.debug_mode){ Log.d(TAG, "onOfferwallAdCredited" + " credits:" + credits + " totalCredits:" + totalCredits + " totalCreditsFlag:" + totalCreditsFlag);}
    ...
    public void onGetOfferwallCreditsFailed(IronSourceError ironSourceError) {
        if(Config.debug_mode){Log.d(TAG, "onGetOfferwallCreditsFailed" + " " + ironSourceError);}
    }

    @Override
    public void onOfferwallClosed() {
        if(Config.debug_mode){Log.d(TAG, "onOfferwallClosed");}
    }
    ...
    void init_adgateMedia(){
        ...
        adGateMedia.loadOfferWall(MainActivity.this,
                Config.adgateMedia_id,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PLAY_REWARDED_VIDEO && resultCode == RESULT_OK) {
            if(Config.debug_mode){ Log.d(TAG, "User was credited");}
        } else if (requestCode == PLAY_REWARDED_VIDEO && resultCode == RESULT_CANCELED) {
            if(Config.debug_mode){Log.d(TAG, "User was not credited");}
        }
    }
    ...
    public void onPointEarn(Context context, EarnPointsOrderList list) {
        for (int i = 0; i < list.size(); ++i) {
            ...
            if(Config.debug_mode){ Log.i("Adxmi", info.getMessage());}
        }
    }
    ...
    public void Redeem(String Gift_Name, int Points_To_Redeem, String Gift_Amount, String Gift_Message) {
        ...
        if (totalPoints >= points) {
            ...
            alert.setPositiveButton(getString(R.string.redeem_now), new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int whichButton) {
                    ...
                    if (user_input.length() >= 5) {
                        ...
                        alert.setMessage(getString(R.string.enter_something));
                        alert.setCanceledOnTouchOutside(false);
            ...
            alert.setMessage(getString(R.string.no_points_to_redeem));
            alert.setCanceledOnTouchOutside(false);
            alert.setButton(getString(R.string.ok2), new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    // Do nothing here
    ...
    void spend(int points, final String type, final String msg){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, awr,
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(MainActivity.this,R.string.server_problem,Toast.LENGTH_SHORT).show();
                    }
                }){
            @Override
            protected Map<String,String> getParams(){
    ...
    private void insertToDatabase(String user_input, String deviceName, String deviceMan, String gift_name, String amount, int points, String po, String Current_Date) {
        ...
        if (App.getInstance().isConnected()) {
            ...
            CustomRequest jsonReq = new CustomRequest(Request.Method.POST, Config.Base_Url + "do_redeem.php", null,
                    new Response.Listener<JSONObject>() {
                        @Override
                        public void onResponse(JSONObject response) {

                            spend(val6, getString(R.string.redeemed_for) +" : "+val5+" - "+val4,val6+" "+ getString(R.string.points_redeemed_for) +" "+val5);
    ...
    private void init_slider() {
        ...
        if(Config.app_theme_ui.intern() == "theme1") {
        ...
        }else if(Config.app_theme_ui.intern() == "theme2"){
        ...
        }else if(Config.app_theme_ui.intern() == "theme3"){

            Numboftabs =2;

            CharSequence Titles[] = {"Home", "Redeem"};
