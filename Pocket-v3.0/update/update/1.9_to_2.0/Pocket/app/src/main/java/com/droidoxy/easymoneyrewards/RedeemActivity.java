...
public class RedeemActivity extends BaseActivity {
	...
	private void initview() {
		...
		CustomAdapter adapter = new CustomAdapter(this, getResources().getStringArray(R.array.payout_titles), Config.payout_images, getResources().getStringArray(R.array.payout_description));
		...
		StringRequest stringRequest = new StringRequest(Request.Method.POST, awr,
				...
				new Response.ErrorListener() {
					...
					public void onErrorResponse(VolleyError error) {
						Toast.makeText(RedeemActivity.this,R.string.server_problem,Toast.LENGTH_SHORT).show();
					}
				}){
			@Override
