...
<!-- Form Starts from Here ..! -->
                  ...
                  <form action="fcm/send_push_all.php" method="post" enctype="multipart/form-data" onsubmit="return checkTextAreaLen()" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
